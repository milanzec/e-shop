...
function getStepContent(step) {
  switch (step) {
    ...
    case 2:
      return <PaymentForm shippingData={shippingData} checkoutToken={checkoutToken} backStep={backStep} nextStep={nextStep} onCaptureCheckout={onCaptureCheckout} refreshCart={refreshCart} timeout={timeout}/>
